      ...
      <main className="container mx-auto px-4 pb-12 pt-28">
        <Card className="mx-auto max-w-2xl border-border/70 p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Quét mã {paymentProvider === "SEPAY" ? "SePay/VietQR" : "VNPAY/VietQR"} bằng app ngân hàng hoặc ví điện tử, kiểm tra đúng số tiền và nội dung chuyển khoản rồi nhấn "Đã quét xong".
          </p>
