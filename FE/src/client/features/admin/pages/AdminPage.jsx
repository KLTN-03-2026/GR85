          ...
          <div className="sticky top-24 space-y-4 rounded-3xl border border-border/60 bg-white/85 p-5 shadow-[0_20px_70px_rgba(15,23,42,0.08)] backdrop-blur">
            <div className="rounded-2xl bg-gradient-to-br from-primary/15 via-white to-accent/10 p-4">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Giao diện quản trị tổng hợp cho hệ thống bán PC, kho, chat và AI
                build.
              </p>
            </div>
        ...
        <main className="min-w-0 flex-1 space-y-6">
            ...
            <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
              <div className="max-w-3xl">
                ...
                <h2 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Bảng điều khiển quản trị cho mô hình PC Perfect kiểu
                  Shopee/Lazada
                </h2>
                <p className="mt-3 text-muted-foreground">
                  Các khối dưới đây được chia theo module đúng theo schema bạn
                  mô tả, để sau này nối API và Prisma vào rất thẳng tay.
                </p>
              </div>
          ...
          <section id="dashboard" className="space-y-6">
            ...
            <div className="grid gap-6 xl:grid-cols-[1.6fr_1fr]">
              ...
              >
                <ChartContainer
                  ...
                  config={{
                    revenue: { label: "Doanh thu", color: "#10b981" },
                    orders: { label: "Đơn hàng", color: "#0f172a" },
                  }}
                >
                  <LineChart
                    data={revenueTrend}
              ...
              <Panel title="Trạng thái đơn hàng" description="Phân bố realtime">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {orderStatusData.map((item) => (
                    <div
                      key={item.name}
                      className="rounded-2xl bg-secondary/70 p-3 text-sm"
                    >
            ...
            <Panel
              ...
              description="Dựa trên OrderItem và tồn kho hiện tại"
            >
              <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <section id="users" className="space-y-6">
            <SectionHeader
              ...
              description="User, Role, Permission và trạng thái tài khoản"
            />
            <Panel
              title="Danh sách user"
              description="Tìm kiếm theo email hoặc tên, ban/unban, chỉnh role"
            >
              <DataTable
                columns={[
                  "Tên",
          ...
          <section id="products" className="space-y-6">
            <SectionHeader
              ...
              description="CRUD, tồn kho, nhiều ảnh, specs và status"
            />
            <div className="grid gap-6 xl:grid-cols-[1.4fr_1fr]">
              <Panel
                title="Kho sản phẩm"
                description="Có thể nối Product, ProductImage, ProductDetail sau"
              >
                <DataTable
                  columns={[
                    "SKU",
              ...
              <Panel
                title="Checklist UI/API"
                description="Các hành động cần có cho admin"
              >
                <Checklist
                  items={[
          ...
          <section id="catalog" className="space-y-6">
            <SectionHeader
              ...
              description="Category CRUD, slug tự động và Supplier management"
            />
            <div className="grid gap-6 xl:grid-cols-2">
              ...
              <Panel
                title="Nhà cung cấp"
                description="Thông tin liên hệ và trạng thái kết nối"
              >
                <DataTable
          ...
          <section id="coupons" className="space-y-6">
            <SectionHeader
              ...
              description="Coupon theo % hoặc số tiền, giới hạn lượt dùng và lịch áp dụng"
            />
            <Panel
              title="Coupon center"
              description="Có thể nối với DiscountType và usage limit"
            >
              <DataTable
                columns={[
                  "Code",
          ...
          <section id="orders" className="space-y-6">
            <SectionHeader
              ...
              description="Filter status, payment status, đổi luồng Pending → Delivered"
            />
            <Panel
              title="Danh sách đơn"
              description="Có thể nối với Order và OrderItem"
            >
              <DataTable
                columns={[
                  "Mã đơn",
          ...
          <section id="payments" className="space-y-6">
            <SectionHeader
              ...
              description="Theo dõi PaymentMethod và PaymentStatus"
            />
            <div className="grid gap-6 xl:grid-cols-[1.4fr_1fr]">
              <Panel
                title="Hiệu suất cổng thanh toán"
                description="Paid / Failed / Refunded theo method"
              >
                <ChartContainer
                  className="h-[320px] w-full"
                  config={{
              ...
              <Panel
                title="Tác vụ nhanh"
                description="Workflow xử lý thanh toán"
              >
                <Checklist
                  items={[
          ...
          <section id="warehouse" className="space-y-6">
            <SectionHeader
              icon={Warehouse}
              title="Quản lý kho"
              description="Warehouse, Batch và SerialNumber"
            />
            <Panel
              title="Tình trạng kho"
              description="Theo dõi còn hàng, đã bán, lỗi hoặc bảo hành"
            >
              <DataTable
                ...
                rows={warehouses.map((warehouse) => [
                  warehouse.name,
                  warehouse.batch,
                  warehouse.available.toString(),
                  warehouse.sold.toString(),
                  warehouse.warranty.toString(),
                ])}
              />
            </Panel>
          </section>
          ...
          <section id="reviews" className="space-y-6">
            <SectionHeader
              ...
              description="Kiểm duyệt review xấu và thống kê rating"
            />
            <Panel
              title="Review moderation"
              description="Ẩn/xóa review và theo dõi sentiment"
            >
              <DataTable
                columns={[
                  "Sản phẩm",
          ...
          <section id="chat" className="space-y-6">
            <SectionHeader
              ...
              description="Realtime room, tin nhắn và trạng thái chat"
            />
            <Panel
              title="Chat room monitor"
              description="Quản lý ChatRoom, Message và phân công staff"
            >
              <DataTable
                columns={[
                  "Room",
          ...
          <section id="ai-build" className="space-y-6">
            <SectionHeader
              icon={Sparkles}
              title="AI Build"
              description="Xem cấu hình user đã build, tổng giá và xu hướng phổ biến"
            />
            <Panel
              title="Build đã lưu"
              description="Dựa trên AiSavedBuild và AiBuildItem"
            >
              <DataTable
                columns={[
                  "Tên build",
                ...
                rows={aiBuilds.map((build) => [
                  build.build,
                  build.owner,
                  build.total,
                  build.items.toString(),
                  statusBadge(build.trend),
                ])}
              />
            </Panel>
          </section>
          ...
          <section id="verification" className="space-y-6">
            <SectionHeader
              ...
              description="Theo dõi OTP, request verify và trạng thái hoàn thành"
            />
            <Panel
              title="Email verification queue"
              description="Có thể nối EmailVerification để check mã OTP"
            >
              <DataTable
                columns={[
                  "Email",
                ...
                rows={emailVerifications.map((item) => [
                  item.email,
                  item.otp,
                  item.requestedAt,
                  item.expiresAt,
          ...
          <section id="roles" className="space-y-6">
            <SectionHeader
              ...
              description="Role, Permission, RolePermission và middleware check quyền"
            />
            <div className="grid gap-6 xl:grid-cols-3">
              {roles.map((role) => (
                <Panel
                  key={role.role}
                  title={role.role}
                  description="Danh sách permission đề xuất"
                >
