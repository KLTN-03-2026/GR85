...
export const suppliers = [
  {
    name: "ASUS Việt Nam",
    contact: "sales@asus.vn",
    phone: "0901 111 222",
    status: "Connected",
  },
  {
    name: "AMD Distributor",
    contact: "amd@dist.vn",
    phone: "0908 222 333",
    status: "Connected",
  },
...
export const reviews = [
  {
    ...
    rating: 5,
    author: "Khách hàng #221",
    excerpt: "Hiệu năng rất ổn, nhiệt độ mát.",
    status: "Published",
  },
  {
    product: "Ryzen 7 7800X3D",
    rating: 2,
    author: "Khách hàng #034",
    excerpt: "Đóng gói chưa kỹ, hộp móp.",
    status: "Need review",
  },
  {
    product: "Samsung 990 Pro 2TB",
    rating: 4,
    author: "Khách hàng #512",
    excerpt: "Tốc độ đúng như mô tả.",
    status: "Published",
  },
];
...
export const chats = [
  {
    room: "ROOM-0932",
    customer: "Khánh Linh",
    lastMessage: "Mình cần build máy stream 35 triệu",
    agent: "AI + Staff",
    status: "Open",
  },
  {
    room: "ROOM-0933",
    customer: "Gia Huy",
    lastMessage: "Đơn hàng mình đang tới đâu?",
    agent: "Staff",
    status: "Pending",
  },
  {
    room: "ROOM-0934",
    customer: "Minh Anh",
    lastMessage: "Tư vấn PSU cho RTX 4080",
    agent: "AI",
    status: "Closed",
  },
];
